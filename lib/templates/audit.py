...
# dependencies = []
# ///
"""Audit script for {{PLUGIN_NAME}}.

Runs every scriptable check of the Kntnt plugin standard. Cognitive checks
(whether a skill's prose is genuinely self-contained, whether a trigger boundary
is sound) stay manual.
